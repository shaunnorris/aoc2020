...
def test_get_slices():
    ...
    assert get_slices(10, 12, 5, 5) == {
        "left": [(5, 4), (5, 3), (5, 2), (5, 1), (5, 0)],
...
def test_find_nearest_seats():
    ...
    assert find_nearest_seats(testdata, 2, 2) == [
        "L",
        "L",
        "L",
        "L",
